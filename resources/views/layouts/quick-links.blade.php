<div class="quick-links">
    ...
    <div class="link-items-wrap">
        @if(!Request::is('resources/catalogs'))
        <div class="link-item">
            <a href="{{ url('/resources/catalogs') }}">
                ...
                <h4 class="ql-subtitle">and new product guides</h4>
            </a>
        ...
        @endif
        <div class="link-item">
            <a href="http://metraonline.com/for-dealers" target="blank">
                <div class="icon-bounce-wrap bounce-catalog">
                ...
                <h4 class="ql-subtitle">of metra products</h4>
            </a>
            <div class="clearfix"></div>
        </div>
    </div>
